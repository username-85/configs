...
nmap <F1> <Nop>
map <F2> :wall<CR>
au FileType c,cpp,h,python nmap <F2> :wall<CR> :!gtags -i<CR>:silent! cs add GTAGS<CR>:cs reset<CR><CR>
au BufEnter *.h,*py nmap <F2> :wall<CR> :!gtags -i<CR>:silent! cs add GTAGS<CR>:cs reset<CR><CR>
